...
//Status  : test
  ...
  /*src_add  	uint32_t		PC ipv4 192.168.2.3
  //dst_add	uint32_t		Xtender adresse 101
  //obj_type  int				Object_type
  //obj_id    uint32_t		User_ref
  //prop_id   uint16_t		Proprety_id
  //value     char*			Value
  //format    int				Format
  //serv      int   			write = 0x2  , read = 0x1

	//User_ref :  -o nombre du parametre
	//Object_type : -t 1 = user_info, 2 = parametres
	//Proprety_id : -i 1 = value , 5 = value_qsp (use 1 for user_info et 5 for parametres)
...
extern int charge_on = 0;
extern float AC_IN_INJ_I_Des = 0;
extern int STATE;int INJ=0;
...
//int Connection(const char* addres,struct connection* socket_struct);
// void Deconnection(struct connection* socket_struct);
//int Read(t_param* Parametre, scom_frame_t* frame, scom_property_t* property ,char* buffer,size_t buffer_length, struct connection* socket_struct,struct studer_data* data,char* ret_val);
//int Write(t_param* Parametre,scom_frame_t* frame, scom_property_t* property ,char* buffer,size_t buffer_length, struct connection* socket_struct, struct studer_data* data,char* ret_val);
extern int connection_mqtt(MQTTClient *client, MQTTClient_connectOptions *conn_opts);

extern float Pl_1[1440]={ 2.827569,
2.827569,
2.827569,
2.827569,
2.827569,
...
1.508569,
1.508569};
extern float Ppv_1[1440]= {  0.000000,
0.000000,
0.000000,
0.000000,
0.000000,
